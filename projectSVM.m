function [accuracySummary,heads] = projectSVM(param, extractFeatures)
...
if (param.crossval==0)
    Mdl = fitcecoc(X,Y,'Coding','ternarycomplete','ClassNames',[-1 0 1]);
else
    CVMdl = fitcecoc(X,Y,'Crossval','on','Coding','ternarycomplete','Learners','linear'); %Cross validation model (10-Fold)
