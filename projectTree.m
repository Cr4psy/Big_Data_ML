function [accuracySummary,heads] = projectTree(param, extractFeatures)
...
display 'DT classifier training'

if (param.crossval==0)
    Mdl = fitcecoc(X,Y,'Coding','ternarycomplete','Learners','tree','ClassNames',[-1 0 1]); %Decision tree
else
    CVMdl = fitcecoc(X,Y,'Crossval','on','Coding','ternarycomplete','Learners','tree','ClassNames',[-1 0 1]); %Cross validation model (10-Fold)
