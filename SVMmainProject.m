...
param.nbDataUsed = 0.01;                % Percentage of the total amount of the dataset selected
param.trainingPercentage = 0.7;      % Percentage of the data set used for training

%Featurization param
param.paramNbHeaders = 50;       % Minimum number of times that a word must appear to be selected in the dictionnary
...
% No iterations
tic
[accuracySummary,heads] = projectKNN(param,extractFeatures);
toc
